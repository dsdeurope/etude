...
const ApiControlPanel = ({ backendUrl }) => {
  ...
  const [apiStatus, setApiStatus] = useState({
    ...
    apis: {
      ...
      gemini_5: { name: 'Gemini Key 5', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_6: { name: 'Gemini Key 6', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_7: { name: 'Gemini Key 7', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_8: { name: 'Gemini Key 8', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_9: { name: 'Gemini Key 9', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_10: { name: 'Gemini Key 10', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_11: { name: 'Gemini Key 11', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_12: { name: 'Gemini Key 12', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_13: { name: 'Gemini Key 13', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
      gemini_14: { name: 'Gemini Key 14', color: 'green', status: 'available', status_text: 'Chargement...', quota_used: 0 },
